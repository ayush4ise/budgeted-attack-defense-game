...
Attacker - Knows the utility function and defender's allocations
"""
import logging
import numpy as np
import pandas as pd
...
logging.basicConfig(level=logging.DEBUG,
                    ...
                    handlers=[logging.FileHandler('logs/case4.log'), logging.StreamHandler()])
...
def case4(**kwargs):
    ...
    attacker_ftype = kwargs.get("attacker_ftype", "actual")
...
if __name__ == '__main__':
    ...
    ATTACKER_FTYPE = "actual"
    results = case4(n_targets=NUM_TARGETS,
